...
int main()
{
	...
	vector<double> lbs_mcmc1, lbs_mcmc2, lbs_mcmc3;
	vector<double> ubs_mcmc1, ubs_mcmc2, ubs_mcmc3;
	vector<double> contents_mcmc1, contents_mcmc2, contents_mcmc3;

	read_file( "weights_test", lbs, ubs, contents );
	read_file( "weights_test2", lbs2, ubs2, contents2 );
	read_file( "weights_test3", lbs3, ubs3, contents3 );
	read_file( "weights_test4", lbs4, ubs4, contents4 );
	read_file( "weights_test5", lbs5, ubs5, contents5 );
	read_file( "weights_test6", lbs6, ubs6, contents6 );
	read_file( "weights_test7", lbs7, ubs7, contents7 );
	read_file( "weights_test8", lbs8, ubs8, contents8 );
	read_file( "weights_test9", lbs9, ubs9, contents9 );
	read_file( "weights_test10", lbs10, ubs10, contents10 );
	read_file( "weights_test11", lbs11, ubs11, contents11 );
	read_file( "weights_test12", lbs12, ubs12, contents12 );
	read_file( "weights_test13", lbs13, ubs13, contents13 );
	read_file( "weights_test14", lbs14, ubs14, contents14 );
	read_file( "weights_test15", lbs15, ubs15, contents15 );
	read_file( "weights_test16", lbs16, ubs16, contents16 );
	read_file( "weights_test17", lbs17, ubs17, contents17 );

	read_file( "mcmc1", lbs_mcmc1, ubs_mcmc1, contents_mcmc1 );
	read_file( "mcmc2", lbs_mcmc2, ubs_mcmc2, contents_mcmc2 );
	read_file( "mcmc3", lbs_mcmc3, ubs_mcmc3, contents_mcmc3 );
	...
	vector< vector<double>> x_mcmc { lbs_mcmc1, lbs_mcmc2, lbs_mcmc3 };
	vector< vector<double>> y_mcmc { contents_mcmc1, contents_mcmc2, contents_mcmc3 };
	...
	titles_mcmc.push_back( "MCMC ICS; 1000 trajs (R0 = 40.0 a0)" );
	titles_mcmc.push_back( "MCMC ICS; 50000 trajs (R0 = 40.0 a0)" );
	titles_mcmc.push_back( "MCMC ICS; 50000 trajs (R0 = 200.0 a0)" );	
