...
***********************************************************************/
{
  ...
  *aufrufe = 0l;
  ...
  std::cout << "INSIDE GEAR4 BEFORE INPUT PARAMETERS CHECK" << std::endl;
  ...
  vmblock = vminit();
  hilf = (REAL *) vmalloc(vmblock, VEKTOR,  n+2, 0);
  f    = (REAL *) vmalloc(vmblock, VEKTOR,  n, 0);
  ykp1 = (REAL *) vmalloc(vmblock, VEKTOR,  n+2, 0);
