...
temperatures_t, moments_t = read_data('theory.txt')
...
lw = 1.75
plt.title(r'\Large \textbf{Zeroth spectral moment}')

plt.xlabel(r'\large \textbf{T}, (K)')
plt.ylabel(r'\large \textbf{M}$_0$, (cm$^{-1}$ $\cdot$ amagat$^{-1}$)')

l, = plt.plot(temperatures_t, moments_t, color = '0.6', linewidth = lw)
e1 = plt.scatter(temperatures_e1, moments_e1, color = 'k', marker = '^', s = 40)
e2 = plt.scatter(temperatures_e2, moments_e2, color = 'k', marker = 's', s = 40)
